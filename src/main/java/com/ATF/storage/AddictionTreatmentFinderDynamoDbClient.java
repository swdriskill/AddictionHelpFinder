 ...
 */
public class AddictionTreatmentFinderDynamoDbClient {
    private final AmazonDynamoDBClient dynamoDBClient;

    public AddictionTreatmentFinderDynamoDbClient (final AmazonDynamoDBClient dynamoDBClient) {
     ...
     * @return
     */
    public AddictionTreatmentFinderUserDataItem loadItem(final AddictionTreatmentFinderUserDataItem tableItem) {
        DynamoDBMapper mapper = createDynamoDBMapper();
        AddictionTreatmentFinderUserDataItem item = mapper.load(tableItem);
        return item;
    }
     ...
     * @param tableItem
     */
    public void saveItem(final AddictionTreatmentFinderUserDataItem tableItem) {
        DynamoDBMapper mapper = createDynamoDBMapper();
