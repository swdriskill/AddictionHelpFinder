 ...
 */
public class AddictionCentersDynamoDbClient {
    private final AmazonDynamoDBClient dynamoDBClient;

    public AddictionCentersDynamoDbClient (final AmazonDynamoDBClient dynamoDBClient) {
     ...
     * @return
     */
    public AddictionCentersDataItem loadItem(final AddictionCentersDataItem tableItem) {
        DynamoDBMapper mapper = createDynamoDBMapper();
        AddictionCentersDataItem item = mapper.load(tableItem);
        return item;
    }
     ...
     * @param tableItem
     */
    public void saveItem(final AddictionCentersDataItem tableItem) {
        DynamoDBMapper mapper = createDynamoDBMapper();
