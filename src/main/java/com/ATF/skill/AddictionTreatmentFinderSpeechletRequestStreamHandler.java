 ...
 * power your function.
 */
public final class AddictionTreatmentFinderSpeechletRequestStreamHandler extends SpeechletRequestStreamHandler {
    ...
    public AddictionTreatmentFinderSpeechletRequestStreamHandler () {
        super(new AddictionTreatmentFinderSpeechlet(), supportedApplicationIds);
    }
}
