...
public class SkillContext {
    ...
    private AddictionUserData addictionUserData;
    ...
    public AddictionUserData getAddictionUserData () {
        return addictionUserData;
    }

    public void setAddictionUserData (AddictionUserData addictionUserData) {
        this.addictionUserData = addictionUserData;
    }
}
